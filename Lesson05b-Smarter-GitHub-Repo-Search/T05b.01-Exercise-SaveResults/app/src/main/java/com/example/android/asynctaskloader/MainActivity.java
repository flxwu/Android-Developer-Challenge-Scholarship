...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_RESULTS_KEY = "jsonKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getString(QUERY_KEY));
            mSearchResultsTextView.setText(savedInstanceState.getString(JSON_RESULTS_KEY));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_KEY, queryUrl);
        ...
        outState.putString(JSON_RESULTS_KEY,jsonResults);
    }
