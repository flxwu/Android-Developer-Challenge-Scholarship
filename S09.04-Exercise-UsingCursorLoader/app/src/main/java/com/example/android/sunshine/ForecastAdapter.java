...
//      COMPLETED (6) Move the cursor to the appropriate position
        ...
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, mCursor.getLong(MainActivity.INDEX_WEATHER_DATE), false);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, mCursor.getInt(MainActivity.INDEX_WEATHER_WEATHER_ID));
